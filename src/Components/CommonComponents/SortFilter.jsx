  ...
  return (
    <div className="relative inline-block text-left">
      <button
        ...
        className="w-[188px] h-[42px] bg-foreground rounded-lg px-4 py-2 shadow-sm text-secondary font-medium focus:outline-none flex items-center justify-start"
      >
      ...
      {isOpen && (
        <div className="absolute mt-2 w-[148px] bg-white rounded-md shadow-lg z-10">
          <ul className="py-1">
            {options.map((option) => (
              <li
                key={option}
